---
title: Racona Developer Documentation
description: Official developer documentation for the Racona webOS system – architecture, database, state management, server actions and other core development topics
template: splash
next:
...
hero:
  title: Racona Developer Documentation
  tagline: Everything you need to know for Racona core development – from architecture to database
  actions:
    - text: Get Started
      link: /en/support/
      icon: right-arrow
